...
@section('title', 'Add New Homepage Section')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0">Add New Homepage Section</h2>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Internal identifier, e.g., hero-banner, features, newsletter</small>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="subtitle" rows="2">{{ old('subtitle') }}</textarea>
                    </div>
