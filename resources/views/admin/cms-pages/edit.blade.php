...
@section('title', 'Edit CMS Page: ' . $cmsPage->title)

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0">Edit CMS Page</h2>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug', $cmsPage->slug) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('content') is-invalid @enderror" 
                                  name="content" rows="12" required>{{ old('content', $cmsPage->content) }}</textarea>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('template') is-invalid @enderror" name="template" required>
                            <option value="default" {{ old('template', $cmsPage->template) == 'default' ? 'selected' : '' }}>Default</option>
                            <option value="full-width" {{ old('template', $cmsPage->template) == 'full-width' ? 'selected' : '' }}>Full Width</option>
                            <option value="sidebar" {{ old('template', $cmsPage->template) == 'sidebar' ? 'selected' : '' }}>With Sidebar</option>
                        </select>
