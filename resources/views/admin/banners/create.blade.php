...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0">{{ isset($banner) ? 'Edit Banner' : 'Add New Banner' }}</h2>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="start_date" 
                                       value="{{ old('start_date', isset($banner) && $banner->start_date ? $banner->start_date->format('Y-m-d') : '') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="end_date" 
                                       value="{{ old('end_date', isset($banner) && $banner->end_date ? $banner->end_date->format('Y-m-d') : '') }}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    @if(isset($banner) && $banner->image)
                        <img src="{{ $banner->image_url }}" class="img-thumbnail mb-2 d-block" style="max-height: 200px;">
                    @endif
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="order" value="{{ old('order', $banner->order ?? 0) }}">
                    </div>
                    ...
                    <button type="submit" class="btn btn-success w-100">
                        <i class="fas fa-save me-2"></i>{{ isset($banner) ? 'Update' : 'Create' }} Banner
                    </button>
                </div>
            </div>
        </div>
